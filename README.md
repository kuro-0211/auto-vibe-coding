...
| 다이어그램 | 설명 |
|---|---|
| [전체 아키텍처](./architecture/architecture.mermaid) | 시스템 전체 구조 |
| [AI 협업 구조](./architecture/architecture_ai.mermaid) | AI 모델 간 역할 분담 |
| [대시보드 구조](./architecture/architecture_dashboard.mermaid) | Streamlit 대시보드 구조 |
| [샌드박스 구조](./architecture/architecture_sandbox.mermaid) | Docker 샌드박스 실행 흐름 |
